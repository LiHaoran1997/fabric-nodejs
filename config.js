...
hfc.setConfigSetting('Dbiir-connection-profile-path',path.join(__dirname, 'artifacts', 'dbiir.yaml'));
hfc.setConfigSetting('Ruc-connection-profile-path',path.join(__dirname, 'artifacts', 'ruc.yaml'));
